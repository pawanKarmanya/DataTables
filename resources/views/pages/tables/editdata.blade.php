                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{ URL::route('continent')}}"><i class="fa fa-fw fa-map-o"></i> Continent table</a></li>
                            </ul>
                        </li>
                        <li class="active treeview">

                            <ul class="treeview-menu">
                                <li><a href="{{ URL::route('country')}}"><i class="fa fa-fw fa-globe"></i> Country table</a></li>
                            </ul>
                        </li>
                                ...
                                <div class="box-body">
                                    <div class="col-md-6 col-md-offset-2">
                                        <div class="box box-primary">
                                            ...
                                            <!-- /.box-header -->
                                            <!-- form start -->
                                            <form method="post" action="{{URL::route('editedRow')}}" role="form">
                                                {{ csrf_field() }}
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="ContinentId" required>
                                                            @foreach($continentname as $values)
                                                            @if($values->Id==$continent)
                                                            <option value="{{$values->Id}}" selected>{{$values->ConName}}</option>
                                                            @else
                                                            <option value="{{$values->Id}}" >{{$values->ConName}}</option>
                                                            @endif
                                                            @endforeach 
